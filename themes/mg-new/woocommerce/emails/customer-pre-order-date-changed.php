...
if ( $availability_date ) {
	$sub_text = 'Your pre-order release date has been changed. The new release date is ' . $availability_date_text . '<br/>. Your order details are shown below for your reference.';
} else {
	$sub_text = 'Your pre-order release date has been changed. Your order details are shown below for your reference.';
}
