...
<div id="reviews" class="reviews">
	<div id="comments">
		<?php if ( have_comments() ) : ?>
			...
			<?php $cpage = get_comment_pages_count( null, 5 ); ?>
			...
			<ol class="commentlist">
				...
				wp_list_comments( apply_filters( 'woocommerce_product_review_list_args', array( 'callback' => 'woocommerce_comments' ) ), $get_comments );
				?>
			</ol>

			<?php if ( $cpage > 1 ) : ?>
				<div class="more-reviews-control">
					<a id="more-reviews-btn" class="button secondary more-reviews-btn" href="#">More Reviews</a>
				</div>
			<?php endif; ?>

		<?php else : ?>
			<p class="woocommerce-noreviews"><?php _e( 'There are no reviews for this product yet.', 'woocommerce' ); ?></p>
		<?php endif; ?>
	</div>
