<?php
  ...
  $logo_url = (!empty($_GET['logoUrl'])) ? $_GET['logoUrl'] : "../assets/images/demostore.png";
?>
...
function ig_showTheSplash() {
    ...
    if (ig_validateCountryCode(igJq.cookie("zCountry"))) { // Only set the splashShown cookie, if there is a valid countryCookie
