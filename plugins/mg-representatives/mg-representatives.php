<?php
/*
Plugin Name: MG Representatives
Plugin URI: https://cgd.io
Description: Functionality for adding, editing, viewing representatives.
Version: 1.0.0
Author: CGD Inc.
...
class MG_Representatives {
	public function __construct() {
		add_action('init', array($this, 'register_cpt') );
		add_action('init', array($this, 'custom_taxonomies') );
		add_action( 'cmb2_admin_init', array($this, 'metaboxes') );
		add_action('pre_get_posts', array($this, 'archives') );
		add_shortcode( 'usa-map', array($this, 'usa_map') );

		// Override CMB2 Handling for rep_zips field
		add_filter('cmb2_override_rep_zips_meta_save', array($this, 'save_zips'), 10, 4);
		add_filter('cmb2_override_rep_zips_meta_value', array($this, 'retrieve_zips'), 10, 4);
	}

	function register_cpt() {
			$rep_labels = array(
		        'name' => _x( 'Representatives', 'representative' ),
		        'singular_name' => _x( 'Representative', 'representative' ),
		        'add_new' => _x( 'Add New', 'representative' ),
		        'add_new_item' => _x( 'Add New Representative', 'representative' ),
		        'edit_item' => _x( 'Edit Representative', 'representative' ),
		        'new_item' => _x( 'New Representative', 'representative' ),
		        'view_item' => _x( 'View Representative', 'representative' ),
		        'search_items' => _x( 'Search Representatives', 'representative' ),
		        'not_found' => _x( 'No representatives found', 'representative' ),
		        'not_found_in_trash' => _x( 'No representatives found in Trash', 'representative' ),
		        'parent_item_colon' => _x( 'Parent Representative:', 'representative' ),
		        'menu_name' => _x( 'Representatives', 'representative' ),
		    );

		    $rep_args = array(
		        'labels' => $rep_labels,
		        'hierarchical' => false,
		        'description' => 'Moore and Giles Representatives',
		        'supports' => array( 'title', 'thumbnail' ),
		        'taxonomies' => array('domestic_territory', 'international_territory', 'representative_area'),
		        ...
		        'query_var' => true,
		        'can_export' => true,
		        'rewrite' => array('with_front' => false, 'slug' => 'representative'),
		        'capability_type' => 'post'
		    );

		    register_post_type( 'representative', $rep_args );
	}

	function custom_taxonomies() {
		$labels = array(
			'name' => _x( 'Domestic Territories', 'domestic_territory' ),
			'singular_name' => _x( 'Domestic Territory', 'domestic_territory' ),
			'search_items' => _x( 'Search Domestic Territories', 'domestic_territory' ),
			'popular_items' => _x( 'Popular Domestic Territories', 'domestic_territory' ),
			'all_items' => _x( 'All Domestic Territories', 'domestic_territory' ),
			'parent_item' => _x( 'Parent Domestic Territory', 'domestic_territory' ),
			'parent_item_colon' => _x( 'Parent Domestic Territory:', 'domestic_territory' ),
			'edit_item' => _x( 'Edit Domestic Territory', 'domestic_territory' ),
			'update_item' => _x( 'Update Domestic Territory', 'domestic_territory' ),
			'add_new_item' => _x( 'Add New Domestic Territory', 'domestic_territory' ),
			'new_item_name' => _x( 'New Domestic Territory', 'domestic_territory' ),
			'separate_items_with_commas' => _x( 'Separate domestic territories with commas', 'domestic_territory' ),
			'add_or_remove_items' => _x( 'Add or remove Domestic Territories', 'domestic_territory' ),
			'choose_from_most_used' => _x( 'Choose from most used Domestic Territories', 'domestic_territory' ),
			'menu_name' => _x( 'Domestic Territories', 'domestic_territory' ),
       );
       ...
       $args = array(
		   ...
		   'rewrite' => array('with_front' => false, 'slug' => '/representatives/domestic-territories'),
		   'query_var' => true
       );

       register_taxonomy( 'domestic_territory', array('representative'), $args );

       $labels = array(
		   'name' => _x( 'International Territories', 'international_territory' ),
		   'singular_name' => _x( 'International Territory', 'international_territory' ),
		   'search_items' => _x( 'Search International Territories', 'international_territory' ),
		   'popular_items' => _x( 'Popular International Territories', 'international_territory' ),
		   'all_items' => _x( 'All International Territories', 'international_territory' ),
		   'parent_item' => _x( 'Parent International Territory', 'international_territory' ),
		   'parent_item_colon' => _x( 'Parent International Territory:', 'international_territory' ),
		   'edit_item' => _x( 'Edit International Territory', 'international_territory' ),
		   'update_item' => _x( 'Update International Territory', 'international_territory' ),
		   'add_new_item' => _x( 'Add New International Territory', 'international_territory' ),
		   'new_item_name' => _x( 'New International Territory', 'international_territory' ),
		   'separate_items_with_commas' => _x( 'Separate international territories with commas', 'international_territory' ),
		   'add_or_remove_items' => _x( 'Add or remove International Territories', 'international_territory' ),
		   'choose_from_most_used' => _x( 'Choose from most used International Territories', 'international_territory' ),
		   'menu_name' => _x( 'International Territories', 'international_territory' ),
       );
       ...
       $args = array(
		   ...
		   'rewrite' => array('with_front' => false, 'slug' => '/representatives/international-territories'),
           'query_var' => true
       );

       register_taxonomy( 'international_territory', array('representative'), $args );

	   $labels = array(
		   'name' => _x( 'Representative Areas', 'representative_area' ),
		   'singular_name' => _x( 'Representative Area', 'representative_area' ),
		   'search_items' => _x( 'Search Representative Areas', 'representative_area' ),
		   'popular_items' => _x( 'Popular Representative Areas', 'representative_area' ),
		   'all_items' => _x( 'All Representative Areas', 'representative_area' ),
		   'parent_item' => _x( 'Parent Representative Area', 'representative_area' ),
		   'parent_item_colon' => _x( 'Parent Representative Area:', 'representative_area' ),
		   'edit_item' => _x( 'Edit Representative Area', 'representative_area' ),
		   'update_item' => _x( 'Update Representative Area', 'representative_area' ),
		   'add_new_item' => _x( 'Add New Representative Area', 'representative_area' ),
		   'new_item_name' => _x( 'New Representative Area', 'representative_area' ),
		   'separate_items_with_commas' => _x( 'Separate representative areas with commas', 'representative_area' ),
		   'add_or_remove_items' => _x( 'Add or remove representative areas', 'representative_area' ),
		   'choose_from_most_used' => _x( 'Choose from the most used representative areas', 'representative_area' ),
		   'menu_name' => _x( 'Representative Areas', 'representative_area' ),
       );
       ...
       $args = array(
		   ...
		   'rewrite' => array('with_front' => false, 'slug' => '/representatives/representative-area'),
		   'query_var' => true
       );

       register_taxonomy( 'representative_area', array('representative'), $args );


	   $labels = array(
		   'name' => _x( 'Representative Zip', 'representative_zip' ),
		   'singular_name' => _x( 'Representative Zip', 'representative_zip' ),
		   'search_items' => _x( 'Search Representative Zips', 'representative_zip' ),
		   'popular_items' => _x( 'Popular Representative Zips', 'representative_zip' ),
		   'all_items' => _x( 'All Representative Zips', 'representative_zip' ),
		   'parent_item' => _x( 'Parent Representative Zip', 'representative_zip' ),
		   'parent_item_colon' => _x( 'Parent Representative Zip:', 'representative_zip' ),
		   'edit_item' => _x( 'Edit Representative Zip', 'representative_zip' ),
		   'update_item' => _x( 'Update Representative Zip', 'representative_zip' ),
		   'add_new_item' => _x( 'Add New Representative Zip', 'representative_zip' ),
		   'new_item_name' => _x( 'New Representative Zip', 'representative_zip' ),
		   'separate_items_with_commas' => _x( 'Separate representative zips with commas', 'representative_zip' ),
		   'add_or_remove_items' => _x( 'Add or remove representative zips', 'representative_zip' ),
		   'choose_from_most_used' => _x( 'Choose from the most used representative zips', 'representative_zip' ),
		   'menu_name' => _x( 'Representative Zips', 'representative_zip' ),
	  );
	  ...
	  $args = array(
		  ...
		  'rewrite' => array('with_front' => false, 'slug' => '/representatives/representative-zips'),
		  'query_var' => true
	  );

	  register_taxonomy( 'representative_zip', array('representative'), $args );

	  $labels = array(
			'name' => _x( 'Representative Industry', 'representative_industry' ),
			'singular_name' => _x( 'Representative Industry', 'representative_industry' ),
			'search_items' => _x( 'Search Representative Industries', 'representative_industry' ),
			'popular_items' => _x( 'Popular Representative Industries', 'representative_industry' ),
			'all_items' => _x( 'All Representative Industries', 'representative_industry' ),
			'parent_item' => _x( 'Parent Representative Industry', 'representative_industry' ),
			'parent_item_colon' => _x( 'Parent Representative Industry:', 'representative_industry' ),
			'edit_item' => _x( 'Edit Representative Industry', 'representative_industry' ),
			'update_item' => _x( 'Update Representative Industry', 'representative_industry' ),
			'add_new_item' => _x( 'Add New Representative Industry', 'representative_industry' ),
			'new_item_name' => _x( 'New Representative Industry', 'representative_industry' ),
			'separate_items_with_commas' => _x( 'Separate representative industries with commas', 'representative_industry' ),
			'add_or_remove_items' => _x( 'Add or remove representative industries', 'representative_industry' ),
			'choose_from_most_used' => _x( 'Choose from the most used representative industries', 'representative_industry' ),
			'menu_name' => _x( 'Representative Industries', 'representative_industry' ),
		);
		...
		$args = array(
			 ...
			 'rewrite' => array('with_front' => false, 'slug' => '/representatives/representative-industries'),
			 'query_var' => true
		);

	 	register_taxonomy( 'representative_industry', array('representative'), $args );
	}

	function metaboxes() {
		$representative_information = new_cmb2_box( array(
			'id'            => 'representative_information',
			'title'         => __( 'Representative Information', 'cmb2' ),
			'object_types'  => array('representative'), // Post type
		) );

		$representative_information->add_field( array(
			'name' => 'Company',
			'desc' => 'The company the representative is associated with.',
			'id'   => 'rep_company',
			'type' => 'text',
		) );
		...
		$representative_information->add_field( array(
			...
			'desc' => 'Any extraordinary information.',
			'id'   => 'rep_additional_info',
			'type' => 'text',
		) );

		$representative_territory = new_cmb2_box( array(
			'id'            => 'representative_territory',
			'title'         => __( 'Representative Territory', 'cmb2' ),
			'object_types'  => array('representative'), // Post type
		) );

		$representative_territory->add_field( array(
			'name' => 'Zip Codes',
			'desc' => 'The zip codes the representative covers. Overrides state and code. Add one per line.',
			'id'   => 'rep_zips',
			'type' => 'textarea_code',
		) );

		$showroom_information = new_cmb2_box( array(
			'id'            => 'showroom_information',
			'title'         => __( 'Showroom Information', 'cmb2' ),
			'object_types'  => array('representative'), // Post type
		) );

		$showroom_information->add_field( array(
			'name' => 'Location',
	...
	function archives( $query ) {
		if ($query->is_tax('domestic_territory') || $query->is_tax('international_territory') || $query->is_tax('representative_area') ) {
			$query->set('post_type','representative');
		}
	}

	function retrieve_zips( $value, $post_id, $object_type, $object ) {
		// Get zips
		$terms = wp_get_post_terms($post_id, 'representative_zip', array('fields' => 'name') );
	...
	function save_zips( $value, $args, $field_args, $field ) {
		$post_id = $args['id'];
		$zips = $args['value'];

		if ( ! empty($zips) ) {
			$zips = explode(PHP_EOL, $zips);

			wp_set_post_terms($post_id, $zips, 'representative_zip', false);
		}

		return $value;
	}

	function usa_map( $atts ) {
		ob_start();
		?>
...
$MG_Representatives = new MG_Representatives();
